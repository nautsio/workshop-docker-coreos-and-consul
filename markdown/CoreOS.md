...
- When new instances appear, the table will be extended.
* try docker run -p :1337:1337 mvanholsteijn/paas-monitor and open http://localhost:1337
...
ExecStart=/bin/sh -c "/usr/bin/docker run --name %p-%i -P <image>"
